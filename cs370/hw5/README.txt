...
1. The problem of producer consumer is solved using ____b______. - 1 point
	a. Mutex Locks
	b. Semaphores

2. What two functions defined in Java are used for synchronization between producer and consumers in your program? ____wait()______ and ____notify()______. - 2 points

3. In which function do you override the body to define the new body of a thread in java? ____run()______. - 1 point

4. Which function is used to wait for a thread to finish and come back to calling program i.e. for a thread to die? _____join()_____. - 1 point
