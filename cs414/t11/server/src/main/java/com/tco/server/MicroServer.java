...
class MicroServer {
    ...
    private void processRestfulAPIrequests() {
        path("/api", () -> {
            ...
            path("/match", () -> {
                get("", (req, res) -> processHttpRequest(req, res, MatchRequest.class));
                post("", (req, res) -> processHttpRequest(req, res, MatchPost.class));
                put("", (req, res) -> processHttpRequest(req, res, MatchPut.class));
                patch("/*", (req, res) -> processHttpRequest(req, res, MatchPatch.class));
            });
            post("/ongoingMatches", (req, res) -> processHttpRequest(req, res, OngoingMatchesRequest.class));
            post("/matchHistory", (req, res) -> processHttpRequest(req, res, MatchHistoryRequest.class));
            path("/user", () -> {
                get("", (req, res) -> processHttpRequest(req, res, UserPost.class));
                post("", (req, res) -> processHttpRequest(req, res, UserPost.class));
                delete("", (req, res) -> processHttpRequest(req, res, UserPost.class));
            });
